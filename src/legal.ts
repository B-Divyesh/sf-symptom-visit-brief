...
const content = privacy ? `
  ...
  <p class="legal-lede">Your symptom records belong to you. Symptom Visit Brief is designed to work without an account and without sending those records to us.</p>
  ...
  <p class="eyebrow">Effective August 28, 2026</p>
  <h1>Terms for a factual memory aid.</h1>
  ...
  <p>Brief Plus is a $9 one-time license for saved symptom presets and personalized brief headings on one browser at a time. The diary and core PDF, CSV, and JSON exports remain free. Sociobot / Dodo is the merchant of record. Refunds are handled through the hosted checkout; a refunded or revoked license may stop verifying.</p>
